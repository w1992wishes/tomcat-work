package com.wan.servletservice.connector.http;
...
import com.wan.servletservice.ServletProcessor;
import com.wan.servletservice.StaticResourceProcessor;
...
public class HttpProcessor {
  ...
  /*protected StringManager sm =
    StringManager.getManager("com.wan.servletservice.connector.http");*/
  ...
  public void process(Socket socket) {
    ...
    try {
      ...
      response.setHeader("Server", "Wan Servlet Container");
